...
/**
 * Base class for the modalCancelButton renderer
 * 
...
public abstract class ModalCancelButtonRendererBase extends RendererBase {
    public static final String RENDERER_TYPE = "org.richfaces.bootstrap.ModalCancelButtonRenderer";
}
