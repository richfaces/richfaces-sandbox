...
@JsfComponent(tag = @Tag(name = "outputFile", type = TagType.Facelets),
        renderer = @JsfRenderer(family = AbstractOutputFile.COMPONENT_FAMILY, type = OutputFileRenderer.RENDERER_TYPE))
