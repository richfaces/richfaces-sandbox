 ...
 * @author Lukas Fryc
 */
@JsfComponent(type = AbstractHotComponent.COMPONENT_TYPE, family = AbstractHotComponent.COMPONENT_FAMILY, renderer = @JsfRenderer(type = "org.richfaces.HotComponentRenderer"), tag = @Tag(type = TagType.Facelets))
